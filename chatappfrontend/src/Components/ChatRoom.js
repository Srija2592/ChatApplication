            ...
            <div className="chat-box">
                ...
                {tab==="CHATROOM" && <div className='chat-content'>
                    ...
                    <div className="send-message">
                        ...
                        <button type="button" className="send-button" onClick={sendPublicMessage}>send</button></div>
                </div>}
                {tab!=="CHATROOM" && <div className="chat-content">
                <ul className="chat-messages">
                {[...privateChats.get(tab)].map((chat,index)=>(
                 ...
                 <div className="send-message">
                        ...
                        <button type="button" className="send-button" onClick={sendPrivateMessage}>send</button></div>
